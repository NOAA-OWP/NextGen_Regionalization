...
for (g1 in gages1) {
    ...
    if (g1 %in% c("01198000","01121000","01117468","01152500","01021480","01044550","01194000")) next  #not sure why these gages have an issue with hfsubset

    outfile <- paste0('../../datasets/gpkg_', ver1,'/gages/huc',h1,"/",g1,'.gpkg')
    #if (file.exists(outfile)) next

    message(paste0(g1," ",match(g1, gages1)))
    cmd1 <- paste0('./hfsubset -l core -o ',outfile,' -r "', ver2,'" -t hl_uri "Gages-',g1,'"')
    #system(cmd1)
