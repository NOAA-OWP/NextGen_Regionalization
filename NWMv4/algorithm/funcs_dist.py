    ...
    for run1 in attrs1: # attr round
        ...
        while len([x for x in recs0 if x in recs1]) != len(recs0):
            ...
            if method == 'gower':
                ...
                #distAttr0.to_csv("distAttr0.csv", index=False, float_format='%.3f')
            ...
            for ii, rec1 in enumerate(recs):
                ...
                #print("number of donors: " + str(len(donors1)))
                ...
                if len(donors1)>0:   
                    ...
                    # assign donor
                    dfDonorAll = pd.concat((dfDonorAll, my_utils.assign_donors(run1, donor1, rec1, config['pars']['general'], dist1, dist_spatial, dfAttrAll)),axis=0) 
                ...
                if len(donors1)==0 and run1=="base":                       
                    ...
                    # assign donor
                    dfDonorAll = pd.concat((dfDonorAll, my_utils.assign_donors("proximity", donor0, rec1, config['pars']['general'], dist0, dist_spatial, dfAttrAll)),axis=0) 
