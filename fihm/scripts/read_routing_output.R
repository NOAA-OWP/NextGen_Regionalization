# reading output from t-route in HDF5 format into Rdata format for all gages in the model domain
...
date1 <- "20081001"
date2 <- "20140930"
regs <- "camels" # regionalization scenarios
...
for (run1 in runs) {
    ...
    #scenario <- paste0(reg1,"_noah_owp_",run1,"_donated")
    scenario <- paste0(reg1,"_noah_owp_",run1,"_default")
