# Create boxplots and scatter plots of stats of different regionalization runs, grouped by objective function,
# model selection, as well as regionalization scenario
